...
int
AnyURI_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static void
AnyURI_1_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
...
void
AnyURI_free(asn_TYPE_descriptor_t *td,
		void *struct_ptr, int contents_only) {
	AnyURI_1_inherit_TYPE_descriptor(td);
	td->free_struct(td, struct_ptr, contents_only);
}

int
AnyURI_print(asn_TYPE_descriptor_t *td, const void *struct_ptr,
...
asn_dec_rval_t
AnyURI_decode_ber(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
AnyURI_encode_der(asn_TYPE_descriptor_t *td,
...
asn_dec_rval_t
AnyURI_decode_xer(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
AnyURI_encode_xer(asn_TYPE_descriptor_t *td, void *structure,
...
static ber_tlv_tag_t asn_DEF_AnyURI_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (12 << 2))
};
asn_TYPE_descriptor_t asn_DEF_AnyURI = {
	"AnyURI",
	"AnyURI",
	AnyURI_free,
	AnyURI_print,
	...
	asn_DEF_AnyURI_tags_1,
	sizeof(asn_DEF_AnyURI_tags_1)
		/sizeof(asn_DEF_AnyURI_tags_1[0]), /* 1 */
	asn_DEF_AnyURI_tags_1,	/* Same as above */
	sizeof(asn_DEF_AnyURI_tags_1)
		/sizeof(asn_DEF_AnyURI_tags_1[0]), /* 1 */
